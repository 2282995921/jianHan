...
var pickerHtml = {
    getHead: function () {
        var head = '<ul class="calendar_num basefix"><li class="bold">六/SAT</li><li>五/FRI</li><li>四/THU</li><li>三/WED</li><li>二/TUE</li><li>一/MON</li><li class="bold">日/SUN</li><li class="picker_today bold" id="picker_today">回到今天</li></ul>';
        htmlObj.header = head;
    },
    getLeft: function () {
        var left = '<div class="control"><div class="calendar_left pkg_double_month"><p class="date_text">' + obj.year + '年' + obj.month + '月</p><a href="javascript:void(0)" title="上一月" id="picker_last" class="pkg_circle_top"></a><a href="javascript:void(0)" title="下一月" id="picker_next" class="pkg_circle_bottom "></a></div></div>';
        htmlObj.left = left;
    },
    getRight: function () {
